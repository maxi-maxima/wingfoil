"""Tests for the wingfoil Fluvio Python bindings.
...
``crates/wingfoil/tests/fluvio_integration.rs`` documents, on the
...
the ``fluvio_admin`` example in ``wingfoil``, the same code the Rust
harness uses.
