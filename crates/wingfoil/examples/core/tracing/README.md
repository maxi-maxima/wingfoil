...
```text
INFO initialise: wingfoil::interp: enter
INFO initialise: wingfoil::interp: close time.busy=127µs time.idle=14.5µs
INFO run: wingfoil::interp: enter
INFO run:apply_nodes{desc="start"}: wingfoil::interp: enter
INFO run:apply_nodes{desc="start"}: wingfoil::interp: close ...
INFO run:cycle: wingfoil::interp: enter
INFO run:cycle: wingfoil: 0.000_000 tick 1
INFO run:cycle: wingfoil::interp: close ...
...
INFO run:apply_nodes{desc="teardown"}: wingfoil::interp: close ...
INFO run: wingfoil::interp: close time.busy=1.94ms time.idle=6.75µs
```
...
```text
INFO run:cycle:cycle_node{index=0 node="Ticker"}: wingfoil::interp: enter
INFO run:cycle:cycle_node{index=1 node="Count"}:  wingfoil::interp: enter
