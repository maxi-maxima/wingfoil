...
|---|---|---|
| `prometheus_adapter` | `PrometheusExporter` + `prometheus_gauge` | [`../prometheus_adapter.rs`](../prometheus/) |
| `otlp_adapter` | the above plus `otlp_push` | [`../otlp_adapter.rs`](../otlp/) |
